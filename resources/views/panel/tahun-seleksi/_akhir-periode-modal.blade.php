    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin mengakhiri dan mengarsipkan periode <strong>{{ $periode->tahun }}</strong>?
                </p>
                <p class="text-danger fw-semibold">Tindakan ini akan mengunci semua data dan menonaktifkan periode ini.
                    Anda tidak akan bisa mengubah data apa pun lagi.</p>
            </div>
