...
<div class="page-content">
    <section class="section">
        ...
        <div class="row">
            {{-- Kolom Kiri: Kartu Profil & Aktivitas --}}
            ...
            {{-- Kolom Kanan: Satu Form Edit yang Tergabung --}}
            <div class="col-12 col-lg-8">
                <form action="{{ route('profil.update') }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    {{-- !! KEDUA FORM SEKARANG DIGABUNG DI SINI !! --}}
                    <div class="card">
                        <div class="card-header">
                        ...
                        {{-- !! TOMBOL SIMPAN PINDAH KE DALAM CARD FOOTER !! --}}
