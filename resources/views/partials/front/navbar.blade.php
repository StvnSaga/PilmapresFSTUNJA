<nav class="navbar navbar-expand-lg sticky-md-top py-3 bg-white shadow-lg"
    ...
    <div class="container">
        ...
        <!-- Menu Navigasi dan Tombol Masuk -->
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center fw-semibold">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#" style="color: #00135E;">Beranda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link scroll-link" href="#tentang" style="color: #00135E;">Tentang</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link scroll-link" href="#panduan" style="color: #00135E;">Panduan</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link scroll-link" href="#timeline" style="color: #00135E;">Timeline</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link scroll-link" href="#rekam-jejak" style="color: #00135E;">Rekam Jejak</a>
                </li>
