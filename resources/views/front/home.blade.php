    ...
    <div class="container">
        ...
        <div class="row g-4 align-items-start">
                    ...
                    <div class="card-body p-4">
                        ...
                        <ul class="list-unstyled mt-3">
                            <li class="d-flex mb-2">
                                <i class="bi bi-check-circle-fill text-orange me-3 mt-1"></i>
                                <span>Mahasiswa aktif program studi di FST UNJA maksimal semester VIII.</span>
                            </li>
                            <li class="d-flex mb-2">
                                <i class="bi bi-check-circle-fill text-orange me-3 mt-1"></i>
                                <span>Usia maksimal 23 tahun (dibuktikan dengan KTP).</span>
                            </li>
                            <li class="d-flex mb-2">
                                <i class="bi bi-check-circle-fill text-orange me-3 mt-1"></i>
                                <span>Belum pernah menjadi finalis Pilmapres tingkat nasional.</span>
                            </li>
                             <li class="d-flex mb-2">
                                <i class="bi bi-check-circle-fill text-orange me-3 mt-1"></i>
                                <span>Berpakaian layak dan memakai jas almamater UNJA saat seleksi.</span>
                            </li>
                        </ul>
            ...
            <div class="col-lg-6">
                ...
                {{-- Komponen ini sudah bagus, tidak perlu diubah --}}
                <x-criteria-card title="Capaian Unggulan" percentage="45%">
                    CU adalah capaian yang diraih oleh mahasiswa dari kegiatan intrakurikuler, kokurikuler, maupun ekstrakurikuler.
                </x-criteria-card>
                <x-criteria-card title="Gagasan Kreatif" percentage="35%">
                    GK adalah tulisan berisi gagasan kreatif peserta untuk penyelesaian permasalahan yang ada pada masyarakat.
                </x-criteria-card>
                <x-criteria-card title="Bahasa Inggris" percentage="20%">
                    Kemampuan dalam menggunakan bahasa Inggris secara lisan dan tulisan dalam konteks akademik maupun nonakademik.
                </x-criteria-card>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center mb-4">
            <div class="col-md-9 text-center text-md-start">
                <h2 class="fw-bold section-title">Rekam Jejak PILMAPRES</h2>
                <p class="text-muted">Pemenang Pemilihan Mahasiswa Berprestasi Fakultas Sains dan Teknologi</p>
            </div>
        </div>

        {{-- !! PERBAIKAN UTAMA ADA DI SINI !! --}}
        {{-- Kita tambahkan pengecekan apakah $rekamJejakGrouped punya data --}}
        @if($rekamJejakGrouped->isNotEmpty())
            <div id="pemenangCarousel" class="carousel slide carousel-dark" data-bs-ride="carousel">
                <div class="carousel-inner">
                    @foreach($rekamJejakGrouped as $tahun => $pemenangGroup)
                    <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                        <h4 class="text-center mb-4 section-title">Pemenang Tahun {{ $tahun }}</h4>
        ...
        @else
            {{-- Tampilkan pesan ini jika tidak ada data rekam jejak sama sekali --}}
...
<script>
    ...
    if (pemenangCarousel) {
        ...
        pemenangCarousel.addEventListener('slid.bs.carousel', function (event) {
